 ...
 */
this.formData.Price = this.itemService.foodItems[ctrl.selectedIndex - 1].Price;
this.formData.ItemName = this.itemService.foodItems[ctrl.selectedIndex - 1].Name;
  ...
  this.dialog.open(ItemComponent, dialogConfig).afterClosed().subscribe(res => {
  });
  }
}
